...
import com.umar.storyappfinal.databinding.ActivityAddStoryBinding
...
class AddStoryActivity : AppCompatActivity() {
    ...
    private fun startTakePhoto() {
        ...
        com.umar.storyappfinal.ui.createTempFile(application).also {
            val photoUri: Uri = FileProvider.getUriForFile(
                this@AddStoryActivity,
                "com.umar.storyappfinal.ui.story",
                it
            )
